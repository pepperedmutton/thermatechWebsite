    ...
    <div className={styles.pageWrapper}>
      <div className={styles.contentArea}>
        ...
        <ProductDetail
          ...
          overview={
            <>
              XHINS-ExB 探针测量系统利用正交的电场（E）和磁场（B）构建一个速度选择器。只有速度 v = E/B 的离子能够无偏转地通过探针的准直孔并被收集器接收。通过扫描电场或磁场强度，可以获得完整的离子速度分布函数（IVDF）。该系统是分析霍尔推进器羽流、离子源束流以及其他等离子体射流中能量色散和速度分布的关键工具。
            </>
          }
          features={[
            '直接测量离子速度分布函数 (IVDF)',
            '高速度/能量分辨率，可分辨不同加速电位下的离子成分',
            '适用于霍尔推进器、离子源及其他等离子体加速装置的羽流诊断',
            '可配置多通道采集，用于空间分布扫描',
