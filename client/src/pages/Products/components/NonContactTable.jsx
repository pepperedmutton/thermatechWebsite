  ...
  <table className={styles.table}>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{renderTextWithMath(t('products.table.nonContact.oes.params'))}</td>
            <td>{t('products.table.nonContact.oes.use')}</td>
          </tr>
          <tr>
            <td>{t('products.table.nonContact.lif')}</td>
            <td>{renderTextWithMath(t('products.table.nonContact.lif.params'))}</td>
            <td>{t('products.table.nonContact.lif.use')}</td>
          </tr>
          <tr>
            <td>{t('products.table.nonContact.thomson')}</td>
            <td>{renderTextWithMath(t('products.table.nonContact.thomson.params'))}</td>
            <td>{t('products.table.nonContact.thomson.use')}</td>
          </tr>
          <tr>
            <td>{t('products.table.nonContact.las')}</td>
            <td>{renderTextWithMath(t('products.table.nonContact.las.params'))}</td>
