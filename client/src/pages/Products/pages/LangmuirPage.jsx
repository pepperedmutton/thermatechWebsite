    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.contentArea}>
        ...
        <ProductDetail
          ...
          features={[
            <>可测量电子密度(<InlineMath math="n_e" />)、离子密度(<InlineMath math="n_i" />)、电子温度(<InlineMath math="T_e" />)、空间电势(<InlineMath math="V_p" />)、悬浮电势(<InlineMath math="V_f" />)及 EEDF</>,
            <>支持圆柱/平面/球型等不同探针结构</>,
        ...
        <ProductDetail
          ...
          features={[
            ...
            <>可测量电子密度(<InlineMath math="n_e" />)、离子密度(<InlineMath math="n_i" />)、电子温度(<InlineMath math="T_e" />)等核心参数，并可配合后处理获取 EEDF</>,
