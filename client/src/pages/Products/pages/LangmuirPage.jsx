    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.contentArea}>
        ...
        <ProductDetail
          ...
          overview={
            <>
              朗缪尔探针测量系统（XHINS-SLP）是用于精确诊断等离子体核心参数的通用解决方案。通过扫描探针的 I-V 特性，系统能够全面测量电子密度、离子密度、电子温度、空间电势、悬浮电势以及电子能量分布函数（EEDF）。我们提供包括单探针、双探针、三探针、发射探针及探针阵列等多种形式，并支持圆柱、平面、球型等不同探针结构，以满足多样化的实验需求。该系统具有测量参数全面、普适性强的特点，可灵活组合使用，深度分析各类等离子体环境。
            </>
          }
          features={[
          ...
          <ProductDetail
            ...
            overview={
              <>
                ...
                系统支持阵列化部署，通过多组三探针单元的空间分布显著提升测量精度与覆盖范围，实现高分辨率的等离子体参数成像。
              </>
            }
            features={[
